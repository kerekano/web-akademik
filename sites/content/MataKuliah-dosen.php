              ...
              <div class="box-body">
                ...
                <div class="col-md-4">
                  <div class="box box-default collapsed-box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Algoritma</h3>
                        ...
                        <a href="#modalMurid" data-toggle="modal" data-toggle="modal" data-target="#modalMurid">
                          <li class="item">
                            ...
                            <div class="product-info">
                              <a class="product-title" href="#modalMurid" data-toggle="modal" data-toggle="modal" data-target="#modalMurid">
                ...
                <div class="col-md-4">
                  <div class="box box-default collapsed-box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Sistem Berbasis Pengetahuan</h3>
                ...
                <div class="col-md-4">
                  <div class="box box-default collapsed-box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Pengantar Teknologi Informasi</h3>
                ...
                <div class="col-md-4">
                  <div class="box box-default collapsed-box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Ga usa dikasih row. 5</h3>
                              ...
                              <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                      <table class="table table-bordered">
                                        ...
                                        <tr>
                                          <td>2.</td>
                                          <td>Reinaldo Sebastian Gunawan</td>
                                          <td>311610015</td>
                                          <td>Teknik Informatika</td>
                                          <td>
                                            <center>
